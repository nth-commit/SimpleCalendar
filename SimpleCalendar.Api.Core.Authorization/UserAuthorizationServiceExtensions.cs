...
namespace SimpleCalendar.Utility.Authorization
{
    ...
    {
        public static Task<bool> CanCreateEventsAsync(
        ...
        public static Task<bool> CanQueryRolesAsync(
            this IUserAuthorizationService userAuthorizationService) =>
